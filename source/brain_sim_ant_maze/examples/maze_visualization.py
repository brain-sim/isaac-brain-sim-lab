...
def visualize_maze(maze, title="Maze Visualization", save_path=None):
    ...
    ax.imshow(
        colors,
        extent=[0, maze_grid.shape[1] * cell_size, 0, maze_grid.shape[0] * cell_size],
    )
...
def main():
    maze = bsAntMaze.from_config_file(
    ...
    visualize_maze(
        maze, "Maze with Custom Configuration", save_path="maze_visualization.png"
    )

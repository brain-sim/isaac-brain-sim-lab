...
class LandmarkEnv(DirectRLEnv):
    ...
    def __init__(
        ...
        component_character_cls: Type[EnvComponentCharacter] = EnvComponentCharacter,
        ...
        **kwargs,
        ...
        self.components = {
            "character": component_character_cls(self),
    ...
    def _setup_scene(self):
        ...
        setup_components = ["robot", "waypoint", "character"]

...
class EnvComponentWaypoint:
    ...
    def generate_waypoint_group(self, env_origins, num_reset, waypoint_offset, perpendicular_offset, robot_xy=None):
    ...
    def generate_waypoints(self, env_ids, robot_poses, waypoint_offset=None, perpendicular_offset=None):
        ...
        if self.env.cfg.num_goals >= 3:
            ...
            third_wp = self.generate_offset_waypoint(env_origins, second_wp, waypoint_offset)

    ...
    def _setup_scene(self):
        ...
        for env_idx in range(self.num_envs):
            ...
            for wall_name, wall_cfg in wall_configs.items():
                ...
                env_wall_cfg = copy.deepcopy(wall_cfg)
                
                # Set the prim path to be environment-specific
                env_wall_cfg.prim_path = f"/World/envs/{env_name}/walls/{wall_name}"
                
                # Adjust the position to account for environment origin
                original_pos = env_wall_cfg.init_state.pos
                env_wall_cfg.init_state.pos = (
